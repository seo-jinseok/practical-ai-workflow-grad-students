# 대학원생을 위한 실용적 AI 워크플로우 v13.0 Part 1: 기초 편
...
이 문서는 **대학원생을 위한 실용적 AI 워크플로우 v13.0** 전체 시리즈 중 **Part 1: 기초 편**입니다.
...
이 Part 1 가이드에 대한 피드백을 주시면 더 나은 v13.0 Part 2를 만들 수 있습니다:
