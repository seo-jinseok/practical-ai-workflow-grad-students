...
```bash
mkdir -p v13.0_resources/part3/images/tools-ecosystem
```
...
```
https://elicit.org/의 스크린샷을 1920x1080 해상도로 캡처하고 v13.0_resources/part3/images/tools-ecosystem/elicit-main.png로 저장해주세요.
```

- **URL**: https://elicit.org/
- **저장 경로**: `v13.0_resources/part3/images/tools-ecosystem/elicit-main.png`
...
```
https://perplexity.ai/의 스크린샷을 1920x1080 해상도로 캡처하고 v13.0_resources/part3/images/tools-ecosystem/perplexity-main.png로 저장해주세요.
```

- **URL**: https://perplexity.ai/
- **저장 경로**: `v13.0_resources/part3/images/tools-ecosystem/perplexity-main.png`
...
```
https://notebooklm.google.com/의 스크린샷을 1920x1080 해상도로 캡처하고 v13.0_resources/part3/images/tools-ecosystem/notebooklm-main.png로 저장해주세요.
```

- **URL**: https://notebooklm.google.com/
- **저장 경로**: `v13.0_resources/part3/images/tools-ecosystem/notebooklm-main.png`
...
```
https://consensus.app/의 스크린샷을 1920x1080 해상도로 캡처하고 v13.0_resources/part3/images/tools-ecosystem/consensus-main.png로 저장해주세요.
```

- **URL**: https://consensus.app/
- **저장 경로**: `v13.0_resources/part3/images/tools-ecosystem/consensus-main.png`
...
```
https://scite.ai/의 스크린샷을 1920x1080 해상도로 캡처하고 v13.0_resources/part3/images/tools-ecosystem/scite-main.png로 저장해주세요.
```

- **URL**: https://scite.ai/
- **저장 경로**: `v13.0_resources/part3/images/tools-ecosystem/scite-main.png`
...
```
https://researchrabbit.ai/의 스크린샷을 1920x1080 해상도로 캡처하고 v13.0_resources/part3/images/tools-ecosystem/researchrabbit-main.png로 저장해주세요.
```

- **URL**: https://researchrabbit.ai/
- **저장 경로**: `v13.0_resources/part3/images/tools-ecosystem/researchrabbit-main.png`
...
```
https://www.connectedpapers.com/의 스크린샷을 1920x1080 해상도로 캡처하고 v13.0_resources/part3/images/tools-ecosystem/connectedpapers-main.png로 저장해주세요.
```

- **URL**: https://www.connectedpapers.com/
- **저장 경로**: `v13.0_resources/part3/images/tools-ecosystem/connectedpapers-main.png`
...
```
https://www.semanticscholar.org/의 스크린샷을 1920x1080 해상도로 캡처하고 v13.0_resources/part3/images/tools-ecosystem/semanticscholar-main.png로 저장해주세요.
```

- **URL**: https://www.semanticscholar.org/
- **저장 경로**: `v13.0_resources/part3/images/tools-ecosystem/semanticscholar-main.png`
...
- **권한 오류**: macOS에서 `chmod -R 755 v13.0_resources/part3/images/` 실행
...
6. https://researchrabbit.ai/ → v13.0_resources/part3/images/tools-ecosystem/researchrabbit-main.png
7. https://www.connectedpapers.com/ → v13.0_resources/part3/images/tools-ecosystem/connectedpapers-main.png
8. https://www.semanticscholar.org/ → v13.0_resources/part3/images/tools-ecosystem/semanticscholar-main.png
```
